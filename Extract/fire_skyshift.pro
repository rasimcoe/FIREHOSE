...
;-
;------------------------------------------------------------------------------
function fire_skyshift, sciimg, sciivar, piximg, slitmask, skymask, edgmask $
                      , subsample = subsample, npoly = npoly $
                      , nbkpts = nbkpts, shiftpix=shiftpix $
...
;                                , lower = sigrej, /silent, yfit=yfit)
      ;;;;;;;;;;;;;;;;;;;
      sky_image[all] = bspline_valu(piximg[all]+shiftpix, skyset) 
