...
;     archive_arc = shift(10^(xmrdfits(getenv("FIRE_DIR")+"/Calib/fire_wvmap_archive.fits.gz")),44,0)
     archive_arc = shift(10^(xmrdfits(getenv("FIRE_DIR")+"/Calib/fire_wvmap_archive.fits.gz")),34,0)
