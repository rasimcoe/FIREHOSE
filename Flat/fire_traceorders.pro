...
if (use_pre_stored_edges EQ 1) then begin
	...
	fsum_trunc = fsum
	fire_find_edges, fsum_trunc, xleft, xright, left_vals, right_vals, /SAW_TOOTH, LOUD=loud, NSECS=10, NORD=norders, MIN_ORDER_WIDTH=min_order_width, DEBUG=debug, _EXTRA=keys
