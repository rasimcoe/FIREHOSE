...
;******************************************************************************
;
pro fire_xfindshift_autofind, SILENT=silent
...
;******************************************************************************
;
pro fire_xfindshift_setup, SILENT=silent
...
function fire_xfindshift_noninteractive, objwave,objflux,telflux,XTITLE=xtitle,$
                                    INITSHIFT=initshift,PARENT=parent,CANCEL=cancel, $
                                    minwv=minwv, maxwv=maxwv

  COMMON xfindshift_state
  fire_xfindshift_initcommon,objwave,objflux,telflux,XTITLE=xtitle,$
                             INITSHIFT=initshift

;  state.r.srange[0]=minwv
;  state.r.srange[1]=maxwv

  fire_xfindshift_setup, /SILENT

  fire_xfindshift_autofind, /SILENT
